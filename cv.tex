...
\vspace{8px}
  ...
  \fullcite{ferguson_2025_15399835}\\
...
\vspace{8px}
  ...
  \begin{enumerate}      
    \item \fullcite{Richards:2025ows}
    \item \fullcite{Kang:2025nio}
    \item \fullcite{Jan:2023raq}
    \item \fullcite{Ferguson:2023vta}
    \item \fullcite{Ferguson:2023mks}
  ...
  \item \fullcite{LISAConsortiumWaveformWorkingGroup:2023arg}\\
  ...
  \begin{enumerate}
  \setcounter{enumi}{\value{papers}}
  \item \fullcite{Swift-BATGUANO:2024vbh}
  \item \fullcite{LIGOScientific:2024elc}
  \item \fullcite{KAGRA:2024ipf}
  \item \fullcite{FermiGamma-RayBurstMonitorTeam:2023mtr}
  \item \fullcite{LIGOScientific:2023lpe}
  \item \fullcite{LIGOScientific:2023bwz}
  \item \fullcite{KAGRA:2023pio}
  \item \fullcite{LIGOScientific:2022hai}
  \item \fullcite{LIGOScientific:2022sts}
  \item \fullcite{LIGOScientific:2022enz}
  \item \fullcite{KAGRA:2022osp}
  \item \fullcite{LIGOScientific:2022jpr}
  \item \fullcite{KAGRA:2022twx}  
  \item \fullcite{KAGRA:2022dqk}
  \item \fullcite{KAGRA:2022dwb}
  \item \fullcite{LIGOScientific:2021quq}
  \item \fullcite{LIGOScientific:2021rnv}
  \item \fullcite{LIGOScientific:2021inr}
  \item \fullcite{LIGOScientific:2021hvc}
  \item \fullcite{KAGRA:2021duu}
  \item \fullcite{LIGOScientific:2021iyk}
  \item \fullcite{KAGRA:2021vkt}
  \item \fullcite{LIGOScientific:2021aug}
  \item \fullcite{KAGRA:2021rmt}
  ...
  \item \fullcite{LIGOScientific:2021ffg}
  \item \fullcite{LIGOScientific:2021mwx}
  \item \fullcite{LIGOScientific:2021izm}
  ...
  \item \fullcite{LIGOScientific:2020lkw}
  \item \fullcite{Abbott:2020mev}
  \item \fullcite{LIGOScientific:2020lst}
  \item \fullcite{LIGOScientific:2020kqk}
