...
\vspace{8px}
  ...
  University of Illinois Urbana-Champaign\\
  Research focus: Numerical relativity with a eye toward next generation detectors\\
  Advisor: Helvi Witek\\
...
\textbf{Invited Talks:}
  ...
  \begin{enumerate}      
     \item Deborah Ferguson, Miguel Gracia-Linares, Erick Martinez, Lu Lu. ``Mayawaves: Python Library for Interacting with the Einstein Toolkit and the MAYA Catalog'', in prep
     \item Deborah Ferguson, Maximillian Trostel, Miguel Gracia-Linares, Erick Martinez, Jacob Lange, Ryan Nowicki, Finny Valorz, Deirdre Shoemaker, and Pablo Laguna. ``MAYA Catalog of Binary Black Hole Numerical Relativity Waveforms'', in prep
  ...
  Chair for Amaldi Conference on Gravitational Waves Session 2023\\
  Member-at-large on Executive Committee of APS Division of Gravitational Physics\\
  Chair for APS April Meeting Session 2022\\
